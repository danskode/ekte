...
// isPrivateIP er flyttet til internal/netsafe så internal/provider kan dele
// samme blokeringsliste. Alias bevares for eksisterende kald og tests.
func isPrivateIP(ip net.IP) bool {
	return netsafe.IsPrivateIP(ip)
}
